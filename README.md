...
[![Status](https://img.shields.io/badge/Status-Design%20%26%20Planning%20Complete-blue?style=for-the-badge)](#-current-project-status)
[![Dev](https://img.shields.io/badge/Development-Starting%20Sprint%201-orange?style=for-the-badge)](#-methodology--agile--scrum)
[![Methodology](https://img.shields.io/badge/Methodology-Agile%20%2F%20Scrum-blueviolet?style=for-the-badge)](#-methodology--agile--scrum)
[![SDLC](https://img.shields.io/badge/SDLC-Full%20Coverage-green?style=for-the-badge)](#-project-report-structure)
[![Diagrams](https://img.shields.io/badge/Diagrams-14%20UML%20%2B%20Wireframes-red?style=for-the-badge)](#-diagrams--artifacts)
...
> **Current Status:** Architectural blueprints and test cases are fully defined. Execution begins with Sprint 1 code implementation.

| Test ID | Module | Test Case | Expected Result | Status |
|---------|--------|-----------|----------------|--------|
| UT-01 | Auth | Register with valid college email | Account created, email sent | ⏳ Pending Implementation |
| UT-02 | Auth | Login with wrong password → 401 | 401 Invalid credentials | ⏳ Pending Implementation |
| UT-03 | Catalog | Search 'oscilloscope' returns EE-003 | Correct result returned | ⏳ Pending Implementation |
| UT-04 | Cart | Add qty > stock → 409 error | 409 Insufficient stock | ⏳ Pending Implementation |
| UT-05 | Orders | Place order → verify inventory decrement | stock_qty reduced in DB | ⏳ Pending Implementation |
| UT-06 | Email | Order placed → email received < 30s | Email dispatched | ⏳ Pending Implementation |
| UT-07 | Inventory | Stock below reorder → admin alert fired | Alert email sent | ⏳ Pending Implementation |
| UT-08 | Reports | Monthly report renders in < 5s | Report generated correctly | ⏳ Pending Implementation |

> Each test case will be executed and updated to ✅ **Pass** as the corresponding Sprint delivers its modules.
...
Phase 3: Design      ████████████████████  ✅ Done
Phase 4: Development ░░░░░░░░░░░░░░░░░░░░  ⏳ Starting Sprint 1
Phase 5: Testing     ░░░░░░░░░░░░░░░░░░░░  ⏳ Planned
Phase 6: Deployment  ░░░░░░░░░░░░░░░░░░░░  ⏳ Planned
```

The architectural blueprints, requirements specification, database schemas, UML diagrams, and UI wireframes are **fully finalized** — all available in the PDF report above.

Core backend development **(Node.js / Express.js)** will begin iteratively following the **4 Sprints** outlined in the methodology section, with each Sprint delivering a testable increment of the system.
...
```
📦 FTSS-Systems-Analysis-Design
 ┣ 📄 README.md
 ┣ 📄 FTSS_Final_Report_v2.pdf       ← Full report — opens directly in GitHub browser
...
|------|-------------|------|
| [📄 FTSS_Final_Report_v2.pdf](./FTSS_Final_Report_v2.pdf) | Full SA&D project report — all chapters, diagrams, and appendices | Opens in browser |
| [📝 FTSS_Final_Report_v2.docx](./FTSS_Final_Report_v2.docx) | Editable Word version | Download |
| [🖼️ use_case_diagram.png](./diagrams/use_case_diagram.png) | UML Use Case Diagram | View |
| [🖼️ dfd_context_diagram.png](./diagrams/dfd_context_diagram.png) | DFD Level 0 — Context Diagram | View |
| [🖼️ dfd_level1.png](./diagrams/dfd_level1.png) | DFD Level 1 — System Processes | View |
| [🖼️ sequence_diagram_place_order.png](./diagrams/sequence_diagram_place_order.png) | Sequence Diagram — Place Order | View |
| [🖼️ order_state_diagram.png](./diagrams/order_state_diagram.png) | Order State Diagram | View |
| [🖼️ order_flowchart.png](./diagrams/order_flowchart.png) | Order Processing Flowchart | View |
